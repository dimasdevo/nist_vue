...
export default {
  ...
  computed:{
    date_agg:{
      ...
      set:function(time){
        let datetime = time;
        this.lunaccs.d_month = parseInt(datetime.substr(5,2));
        this.lunaccs.d_year = parseInt(datetime.substr(0,4));
      }
    },
  },
  methods: {
    ...
    openDialogAdd(data) {
      this.dialog = true;
      this.lunaccs.c_stor_lun = data.c_stor_lun;
      this.title = "FORM ADD LUN ACCUMULATE";
      this.type = "add";
    },
    openDialogEdit(data) {
      this.dialog = true;
      this.lunaccs = data;
      this.title = "FORM EDIT LUN ACCUMULATE";
      this.type = "edit";
    },
